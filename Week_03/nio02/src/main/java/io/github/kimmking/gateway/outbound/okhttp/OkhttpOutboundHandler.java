...
//
//            @Override
//            public void onResponse(@NotNull Call call, @NotNull Response endpointResponse) throws IOException {
...
//        });
    ...
    private void handleResponse(FullHttpRequest fullRequest, ChannelHandlerContext ctx, Response endpointResponse) {
